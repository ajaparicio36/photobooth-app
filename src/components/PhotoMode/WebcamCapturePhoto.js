    ...
    const initializeWebcam = async () => {
        try {
            ...
            if (videoRef.current) {
                ...
                console.log("Video element readyState before:", videoRef.current.readyState);
            ...
            if (error instanceof DOMException) {
                ...
                switch (error.name) {
                    ...
                    case "OverconstrainedError":
                        console.log("Constraints too restrictive, trying basic constraints...");
